...
public class VanFormController {
    ...
    private ObservableList<ItemDTO> vanpart= FXCollections.observableArrayList();
    ...
    private void LoadAllData() {
        vanpart.clear();
        try {
           vanpart = allPartsbo.getvehicle("van");
            tblvan.setItems(vanpart);
        } catch (Exception ex) {
    ...
    private void Search() {
        FilteredList<ItemDTO> filteredListdata=new FilteredList<>(vanpart, e->true);
        txtsearch.setOnKeyReleased(e->{
            ...
            sortedList.comparatorProperty().bind(tblvan.comparatorProperty());
            tblvan.setItems(sortedList);
        });
